...
<body>
    ...
    <div class="main-content">
        <div class="copy-container">
            <h2>Iphone</h2>
            <ul id="ul-container">
                <li class="content_list"><img src="images/iphone 8.png" title="Iphone 8" width="300" height="350">
                    <h4>Iphone 8 64 GB</h4>
                    <h3>Rp 2.899.000</h3>
                </li>
                <li class="content_list"><img src="images/iphone X.png" title="Iphone X" width="300" height="350">
                    <h4>Iphone X 64 GB</h4>
                    <h3>Rp 4.690.000</h3>
                </li>
                <li class="content_list"><img src="images/iphone XS.png" title="Iphone X" width="300" height="350">
                ...
                <li class="content_list"><img src="images/iphone xs max.png" title="Iphone X" width="300" height="350">
                    <h4>Iphone XS MAX 64 GB</h4>
                    <h3>Rp 5.290.000</h3>
                </li>
                <li class="content_list"><img src="images/iphone 11.png" title="Iphone X" width="300" height="350">
                    <h4>Iphone 11 64 GB</h4>
                    <h3>Rp 6.298.000</h3>
                </li>
                <li class="content_list"><img src="images/iphone 11 pro max.png" title="Iphone X" width="230" height="350">
                    <h4>Iphone 11 PRO MAX 64 GB</h4>
                    <h3>Rp 8.998.000</h3>
                </li>
                <li class="content_list"><img src="images/iphone 12.png" title="Iphone X" width="300" height="350">
                ...
                <li class="content_list"><img src="images/iphone 12 pro max.png" title="Iphone X" width="230" height="350">
                    <h4>Iphone 12 pro max 512 GB</h4>
                    <h3>Rp 14.000.000</h3>
                </li>
                <li class="content_list"><img src="images/iphone 13.png" title="Iphone X" width="300" height="350">
                    <h4>Iphone 13 256 GB</h4>
                    <h3>Rp 12.600.000</h3>
                </li>
                <li class="content_list"><img src="images/iphone 13 pro max.png" title="Iphone X" width="300" height="350">
    ...
    <div class="footer">
        <h2>About Me</h2>
        <div class="foto">
            <img src="images/PHOTO.jpg" title="Ahmad Lutfi Alfares" width="500" height="350" >
        </div>
        <div class="isi-diri">
            <table>
                <tr>
